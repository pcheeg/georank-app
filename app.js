...
function renderHome() {
  ...
  document.getElementById('playBtn').onclick = () => done ? renderAdmireResult(done, false) : renderGame();
...
function renderStats() {
  ...
  const todayResult = state.results[puzzleNo];
  app.innerHTML = `
    <section class="screen">
      ...
      <div class="hero stats-hero">
        ...
        ${todayResult ? `
          <div class="today-result">
            ...
            <div class="mini-score">${todayResult.score}</div>
            <div class="feedback small-feedback">${todayResult.feedback}</div>
            <div class="btns compact">
              <button class="btn secondary" id="statsAdmireBtn">Admire</button>
              <button class="btn secondary" id="statsAnswersBtn">Answers</button>
              <button class="btn" id="statsShareBtn">Share</button>
            </div>
          </div>` : ``}
      </div>
  ...
  if (todayResult) {
    document.getElementById('statsAdmireBtn').onclick = () => renderAdmireResult(todayResult, false);
    document.getElementById('statsAnswersBtn').onclick = () => renderAnswersResult(todayResult);
    document.getElementById('statsShareBtn').onclick = () => shareResult(todayResult);
  }
}
